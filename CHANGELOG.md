...
- Fix error using <span style="font-family: monospace;">windll</span> on <span style="font-family: monospace;">posix</span> systems
- Fix error using the <span style="font-family: monospace;">MonokaiPlusPlusStyle</span> style in <span style="font-family: monospace;">CodeSyntaxHighlight</span>
- Add VERSIONS file
## 202507291540
- First release
